...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf>{
	...
	/**
	 * 当设置一个新的容量值时，会对原有的ByteBuf进行改变，若新容量小于原容量，则截断部分内容，若新容量大于原容量，则返回一个更大的Bytebuf</p>
     * Adjusts the capacity of this buffer.  If the {@code newCapacity} is less than the current
     * capacity, the content(内容) of this buffer is truncated(截断).  If the {@code newCapacity} is greater
     * than the current capacity, the buffer is appended with unspecified(未指明的) data whose length is
